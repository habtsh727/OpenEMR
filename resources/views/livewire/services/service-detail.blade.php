 <flux:modal name="service-detail" class="md:w-196">
    <div class="space-y-6">
        <!-- Header Section -->
        <div class="border-b border-gray-200 pb-4">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                    <flux:heading size="lg" class="text-gray-900">Service</flux:heading>
        ...
        <div class="rounded-lg border border-sky-100 bg-sky-50 p-4">
            <div class="mb-3 flex items-center gap-2">
                ...
                <flux:heading size="sm" class="text-sky-900">Price: {{ $price }}</flux:heading>
            </div>
