<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(!$showReportForm && !$showSessionDetail)
            <!-- Header -->
            <div class="mb-8">
                <div class="bg-gradient-to-r from-purple-900 via-purple-800 to-purple-900 dark:from-purple-950 dark:via-purple-900 dark:to-purple-950 rounded-2xl shadow-2xl overflow-hidden relative">
