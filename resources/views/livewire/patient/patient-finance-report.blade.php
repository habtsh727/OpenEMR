    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    ...
                                    <td
                                        ...
                                        ETB {{ number_format($payment['paid_amount'], 2) }}</td>
                                    <td class="px-4 py-3">
                                        <span
        ...
        <div x-show="showPrintView" x-cloak class="print-content">
            <div style="background: white; padding: 15px; max-width: 100%; margin: 0 auto; font-size: 11px;">
                ...
                <!-- Payments by Encounter - Compact Tables -->
                @forelse($financialData as $encounter)
                <div
                    ...
                    <!-- Compact Table with Smaller Font -->
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
                        ...
                        <div style="display: flex; gap: 15px;">
                            <div style="text-align: right;">
                                ...
                                <p style="font-size: 12px; font-weight: bold; margin: 2px 0;">ETB {{
                                    number_format($grandTotal, 0) }}</p>
                            </div>
                            <div style="text-align: right;">
                                <p style="font-size: 8px; color: #666; margin: 0;">Disc</p>
                                <p style="font-size: 12px; font-weight: bold; color: #16a34a; margin: 2px 0;">ETB {{
                                    number_format($totalDiscount, 0) }}</p>
                            </div>
                            <div style="text-align: right;">
                                <p style="font-size: 8px; color: #666; margin: 0;">Paid</p>
                                <p style="font-size: 12px; font-weight: bold; color: #059669; margin: 2px 0;">ETB {{
