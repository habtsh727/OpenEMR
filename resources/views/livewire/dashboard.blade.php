        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                ...
                                <div class="flex flex-col items-end gap-2">
                                    <div class="flex gap-3">
                                        <select wire:model.live="dateRange"
                                            class="px-4 py-2 rounded-lg bg-white/20 text-white border border-white/30 text-sm">
                                        ...
                                        <input type="date" wire:model.live="selectedDate"
                                            class="px-4 py-2 rounded-lg bg-white/20 text-white border border-white/30">
                                        @endif
                                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                    <!-- Card Sales -->
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition group">
                        <div class="flex items-center justify-between mb-2">
                            <div
                                class="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg group-hover:scale-110 transition">
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white">ETB {{ number_format($cardSales, 2)
                            }}</p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <div
                                class="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg group-hover:scale-110 transition">
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white">ETB {{ number_format($pharmacySales,
                            2) }}</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white">ETB {{ number_format($cuppingSales,
                            2) }}</p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <div
                                class="p-2 bg-amber-100 dark:bg-amber-900/30 rounded-lg group-hover:scale-110 transition">
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white">ETB {{ number_format($rehabSales, 2)
                            }}</p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <div
                                class="p-2 bg-rose-100 dark:bg-rose-900/30 rounded-lg group-hover:scale-110 transition">
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white">ETB {{ number_format($bedSales, 2) }}
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <div
                                class="p-2 bg-cyan-100 dark:bg-cyan-900/30 rounded-lg group-hover:scale-110 transition">
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white">ETB {{ number_format($radiologySales,
                            2) }}</p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <div
                                class="p-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg group-hover:scale-110 transition">
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white">ETB {{ number_format($labSales, 2) }}
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-900 dark:text-white">{{ number_format($totalPatients)
                                }}</p>
                        ...
                        <div class="p-2 bg-orange-100 dark:bg-orange-900/30 rounded-lg">
                            <svg class="w-5 h-5 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <path fill-rule="evenodd"
                                    d="M4 5a2 2 0 012-2 1 1 0 000-2 4 4 0 00-4 4v9a4 4 0 004 4h12a4 4 0 004-4V5a4 4 0 00-4-4 1 1 0 000 2 2 2 0 012 2v9a2 2 0 01-2 2H6a2 2 0 01-2-2V5z" />
                            </svg>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg">
                            <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                <path
                                    d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v-1h8v1z" />
                            </svg>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            ...
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-3">
                                <div class="bg-emerald-500 h-2 rounded-full" style="width: {{ $stats['percentage'] }}%">
                                </div>
                            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <div class="flex justify-between mb-2">
                                ...
                                <span class="text-sm font-semibold text-{{ $data['color'] }}-600">{{ $data['status']
                                    }}</span>
                            </div>
                ...
                <div
                    ...
                    <div class="space-y-3 max-h-80 overflow-y-auto">
                        ...
                        <div
                            class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition">
                            <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-bold text-green-600">ETB {{ number_format($sale->amount, 2)
                                }}</span>
                        </div>
                        @empty
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                <td class="px-6 py-3 text-sm font-mono text-gray-900 dark:text-white">{{
                                    $patient->card_number }}</td>
                                <td class="px-6 py-3 text-sm font-medium text-gray-900 dark:text-white">{{
                                    $patient->first_name }} {{ $patient->last_name }}</td>
                                <td class="px-6 py-3 text-sm text-gray-600 dark:text-gray-400">{{ $patient->gender }}
                                </td>
                                <td class="px-6 py-3 text-sm text-gray-600 dark:text-gray-400">{{
                                    $patient->phone_number1 }}</td>
                                <td class="px-6 py-3 text-sm text-gray-500">{{ $patient->created_at->format('M d, Y') }}
                                </td>
                            </tr>
                            @empty
                            <tr>
            ...
            {{-- Footer --}}
            <div
                class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center text-xs text-gray-500">
