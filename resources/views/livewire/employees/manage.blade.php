<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage your hospital staff and their roles</p>
        </div>
        <button wire:click="create"
                class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm transition-all duration-200 flex items-center gap-2">
        ...
        <div class="lg:col-span-2">
            <div class="relative">
                ...
                <input wire:model.live.debounce.300ms="search" 
                       ...
                       class="pl-10 w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
        </div>
        <div class="flex items-center justify-end">
            <div class="text-sm text-gray-600">
                Total: <span class="font-semibold">{{ $employees->total() }}</span> employees
            </div>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col gap-1">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold 
                                        ...
                                        @elseif($employee->role === 'doctor') bg-purple-100 text-purple-800
                                        @elseif($employee->role === 'nurse') bg-pink-100 text-pink-800
                                        @elseif($employee->role === 'cashier') bg-green-100 text-green-800
                                        @else bg-blue-100 text-blue-800 @endif">
                                        {{ ucfirst($employee->role) }}
                                    </span>
                                    <span class="text-xs text-gray-500">Employee ID: {{ $employee->id }}</span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-1">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <span class="font-mono bg-gray-100 px-2 py-0.5 rounded text-xs">{{ $employee->employee_code }}</span>
                                    </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium {{ $employee->status === 'active' ? 'text-green-700' : 'text-red-700' }}">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="alert('View feature coming soon!')"
                                            class="p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors duration-150"
                                            title="View Profile">
                                    ...
                                    <div class="relative" x-data="{ open: false }">
                                        <button @click="open = !open"
                                                class="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors duration-150"
                                                title="More options">
                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
    ...
    @if($showModal)
        <div class="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto p-4 bg-black/25 backdrop-blur-sm">
                    ...
                    <form wire:submit.prevent="save" class="px-6 py-5 space-y-5">
                        ...
                        <div>
                            ...
                            <select wire:model="user_id" 
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('user_id') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <select wire:model="role" 
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('role') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input wire:model="employee_code" 
                                       ...
                                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 pl-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('employee_code') border-red-500 @enderror">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
