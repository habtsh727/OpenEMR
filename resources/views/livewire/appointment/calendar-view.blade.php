<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <!-- Header with Stats -->
        <div
            class="bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-800 dark:to-teal-800 rounded-2xl shadow-xl p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-100 dark:text-emerald-200 mt-1">Manage appointments by date and doctor
                        </p>
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white min-w-[200px] text-center">
                        ...
                        @elseif($view === 'week')
                        {{ $currentDate->startOfWeek()->format('M d') }} - {{ $currentDate->endOfWeek()->format('M d,
                        Y') }}
                        @else
                ...
                <div class="flex items-center gap-2">
                    <select wire:model.live="selectedDoctor"
                        class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500">
        ...
        <div
            ...
            <div class="grid grid-cols-7 divide-x divide-gray-200 dark:divide-gray-700">
                ...
                <div wire:click="selectDate('{{ $day['formatted'] }}')" class="min-h-[120px] p-2 cursor-pointer transition-all hover:bg-gray-50 dark:hover:bg-gray-700/50
                    ...
                    <div class="flex justify-between items-start mb-2">
                        <span
                            class="text-sm font-medium {{ $day['is_today'] ? 'text-emerald-600 dark:text-emerald-400 font-bold' : '' }}">
                            {{ $day['day'] }}
                        </span>
                        @if($day['total'] > 0)
                        <span
                            class="text-xs px-1.5 py-0.5 bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400 rounded-full">
                            {{ $day['total'] }}
                        </span>
                        @endif
                    </div>
                        ...
                        <div class="flex flex-wrap gap-1">
                            ...
                            <span class="flex items-center gap-0.5">
                                ...
                                <span class="text-xs text-gray-600 dark:text-gray-400">{{
                                    $day['status_counts']['scheduled'] }}</span>
                            </span>
                            @endif
                            @if($day['status_counts']['completed'] > 0)
                            <span class="flex items-center gap-0.5">
                                ...
                                <span class="text-xs text-gray-600 dark:text-gray-400">{{
                                    $day['status_counts']['completed'] }}</span>
                            </span>
                            @endif
                        </div>
            ...
            <div class="grid grid-cols-7 divide-x divide-gray-200 dark:divide-gray-700">
                ...
                <div class="min-h-[600px] p-2 {{ $day['is_today'] ? 'bg-emerald-50/50 dark:bg-emerald-900/10' : '' }}">
                    ...
                    <div wire:click="selectDate('{{ $day['formatted'] }}')"
                        ...
                        <span
                            class="text-sm font-medium {{ $day['is_today'] ? 'text-emerald-600 dark:text-emerald-400' : '' }}">
                            {{ $day['name'] }}
                        </span>
                            ...
                            <div class="space-y-1 max-h-[100px] overflow-y-auto">
                                ...
                                <div wire:click="selectAppointment({{ $appointment->id }})"
                                    ...
                                    <div class="flex justify-between items-start">
                                        <span
                                            class="text-xs font-medium text-gray-900 dark:text-white truncate max-w-[80px]">
            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div wire:click="selectAppointment({{ $appointment->id }})"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <!-- Patient Avatar -->
                        <div
                            class="h-12 w-12 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold text-lg">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-3">
                                ...
                                <span
                                    class="px-2 py-1 text-xs rounded-full {{ $this->getStatusBadgeColor($appointment->status) }}">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                            {{ $appointment->appointment_time->format('h:i A') }} • Dr. {{
                                            $appointment->doctor->name }}
                                        </div>
                                    </div>
                                </div>
                                <span
                                    class="px-3 py-1 text-xs rounded-full {{ $this->getStatusBadgeColor($appointment->status) }}">
                                    {{ ucfirst($appointment->status) }}
                                </span>
                            </div>
                        </div>
                ...
                <div class="p-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-4">
                        <div class="flex items-center gap-3 mb-3">
                            <div
                                class="h-12 w-12 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold text-lg">
                                {{ substr($selectedAppointment->patient->first_name ?? 'N', 0, 1) }}{{
                                substr($selectedAppointment->patient->last_name ?? 'A', 0, 1) }}
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-sm">
                            <div>
                                ...
                                <p class="font-medium text-gray-900 dark:text-white">{{
                                    $selectedAppointment->patient->phone_number1 }}</p>
                            </div>
                            <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-sm font-medium text-gray-900 dark:text-white">Dr. {{
                                $selectedAppointment->doctor->name }}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <span
                                class="px-3 py-1 text-xs rounded-full {{ $this->getStatusBadgeColor($selectedAppointment->status) }}">
                        ...
                        <div class="py-2">
                            ...
                            <p
                                class="text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
