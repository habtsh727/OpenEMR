    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">View and manage appointment #{{ $appointment->id
                        }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                @if($appointment->status === 'scheduled' && $appointment->appointment_time->isPast() &&
        ...
        <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white">
                            {{ $appointment->patient->first_name }} {{ $appointment->patient->middle_name }} {{
                            $appointment->patient->last_name }}
                        </h2>
                        <div class="flex items-center gap-4 mt-1 text-blue-100">
                            <span>Card: {{ $appointment->patient->card_number }}</span>
                            <span>•</span>
                            <span>{{ ucfirst($appointment->patient->gender) }}, {{
                                \Carbon\Carbon::parse($appointment->patient->date_of_birth)->age }} yrs</span>
                            <span>•</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 divide-x divide-gray-200 dark:divide-gray-700">
                ...
                <div class="p-4 text-center">
                    ...
                    <span
                        class="inline-flex mt-1 px-3 py-1 rounded-full text-xs font-medium {{ $appointment->status_color }}">
                ...
                <div class="p-4 text-center">
                    ...
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $appointment->creator->name ??
                        'System' }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="inline-flex mt-1 px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <span
                                            class="px-2 py-1 text-xs rounded-full {{ $appointment->payment_status_color }}">
                                            {{ ucfirst($appointment->payment_status) }}
                                        </span>
                                        @if($appointment->payment_amount)
                                        <span class="ml-2 text-sm font-medium">ETB {{
                                            number_format($appointment->payment_amount, 2) }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div
                            class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 flex justify-between items-center">
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-lg font-bold">ETB {{ number_format($appointment->payment_amount, 2)
                                    }}</span>
                            </div>
                            @endif
                            ...
                            <li>
                                <div class="relative pb-8">
                                    ...
                                    <div class="relative flex items-start space-x-3">
                                        <div class="relative">
                                            <div
                                                class="h-10 w-10 rounded-full bg-{{ $history->action === 'created' ? 'green' : ($history->action === 'cancelled' ? 'red' : 'blue') }}-100 flex items-center justify-center ring-8 ring-white">
        ...
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            <div class="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-6">
                ...
                <p class="mb-4">Check in <span class="font-semibold">{{ $appointment->patient->first_name }} {{
                        $appointment->patient->last_name }}</span>?</p>
                <div class="flex justify-end gap-3">
                    <button wire:click="$set('showCheckInModal', false)"
                        class="px-4 py-2 border rounded-lg">Cancel</button>
                    <button wire:click="confirmCheckIn" class="px-4 py-2 bg-green-600 text-white rounded-lg">Check
                        In</button>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-6">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button wire:click="confirmComplete"
                        class="px-4 py-2 bg-emerald-600 text-white rounded-lg">Complete</button>
                </div>
            </div>
        </div>
        @endif
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl max-w-lg w-full p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea wire:model="rescheduleReason" rows="2" class="w-full border rounded-lg px-3 py-2"
                ...
                <div class="flex justify-end gap-3 mt-6">
                    ...
                    <button wire:click="reschedule"
                        class="px-4 py-2 bg-yellow-600 text-white rounded-lg">Reschedule</button>
                </div>
            </div>
        </div>
        @endif
        ...
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            <div class="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-6">
                ...
                <textarea wire:model="rescheduleReason" rows="2" class="w-full border rounded-lg p-3 mb-4"
