<div class="space-y-6" x-data="{
     ...
     "
     x-on:scroll-to-question.window="
        const element = document.getElementById('question-' + $event.detail.questionId)
        if (element) {
    ...
    <form wire:submit.prevent="submitQuestionnaire" class="space-y-5">
                ...
                <div id="question-{{ $question->id }}" wire:key="question-{{ $question->id }}"
                    ...
                    <div class="space-y-4 pl-2">
                        ...
                        <div x-data="{ showNote: @entangle('answers.' . $question->id . '.note').live }" class="mt-2">
                            <div x-show="!showNote && !@entangle('answers.' . $question->id . '.note')" class="flex justify-end">
                            ...
                            <div x-show="showNote || @entangle('answers.' . $question->id . '.note')" x-cloak>
                                <div class="flex items-start gap-2.5 p-3.5 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-200 dark:border-amber-800/30">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <textarea wire:model.live="answers.{{ $question->id }}.note" rows="2"
                                            class="w-full px-3 py-2 text-sm bg-white dark:bg-gray-800 border border-amber-300 dark:border-amber-700 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:text-white"
        ...
        <!-- Form Actions - Only Submit Button -->
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-4 backdrop-blur-sm bg-white/95 dark:bg-gray-800/95">
                <div class="flex flex-col items-center justify-between gap-3">
                    <div class="flex items-center gap-2 w-full">
                        <a href="{{ route('rehab.queue') }}" wire:navigate
                            class="flex-1 inline-flex items-center justify-center px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors gap-2">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="flex-1 inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 gap-2 min-w-[200px]">
                    ...
                    <!-- Form Metadata -->
                    <div class="pt-3 border-t border-gray-100 dark:border-gray-700 w-full">
                        <div class="flex flex-wrap items-center justify-center gap-3 text-xs">
                            <div class="flex items-center gap-3 text-gray-500 dark:text-gray-400">
                                ...
                                <span class="flex items-center gap-1">
                                    ...
                                    Answers are saved on submission
                                </span>
                            </div>
    ...
    <div x-data="{ show: false, message: '', type: 'success' }"
         ...
         x-show="show"
         x-transition
         class="fixed bottom-6 right-6 px-6 py-3 rounded-xl shadow-lg flex items-center gap-2 z-50"
         :class="{
