...
<form wire:submit.prevent="submitQuestionnaire" class="space-y-5">
    ...
    <div id="question-{{ $question->id }}" wire:key="question-{{ $question->id }}"
        ...
        <div class="flex items-start gap-3 mb-4">
            <span class="flex items-center justify-center w-6 h-6 rounded-lg bg-gradient-to-br from-teal-500 to-cyan-600 text-white text-xs font-semibold shadow-sm">
                {{ $loop->iteration }}
            </span>
            ...
            <div x-data="{ showNote: @entangle('answers.' . $question->id . '.note').live }" class="mt-2">
                ...
                <div x-show="showNote || @entangle('answers.' . $question->id . '.note')" 
                    ...
                    <div class="flex items-start gap-2.5 p-3.5 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-200 dark:border-amber-800/30">
                        <svg class="w-4 h-4 text-amber-600 dark:text-amber-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <button type="button" 
                        ...
                        <svg wire:loading wire:target="saveProgress" class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                ...
                <button type="submit" 
                    ...
                    <svg wire:loading wire:target="submitQuestionnaire" class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
