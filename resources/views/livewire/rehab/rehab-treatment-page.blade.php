<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('rehab.treatment.queue') }}" wire:navigate class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white flex items-center gap-1 transition-colors">
            ...
            <div class="p-6">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <div class="h-16 w-16 rounded-full bg-gradient-to-br from-emerald-600 to-teal-600 flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                            ...
                            @foreach($treatmentTypes as $type)
                                <button wire:click="selectType({{ $type->id }})" 
                                    ...
                                    <div class="flex items-center gap-3 mb-3">
                                        <div class="p-2 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg group-hover:bg-emerald-500 transition-colors">
                                            <div class="w-5 h-5 text-emerald-600 dark:text-emerald-400 group-hover:text-white">
                                                {!! $type->icon_html !!}
                                            </div>
                                        </div>
                                        <h3 class="font-semibold text-gray-900 dark:text-white group-hover:text-emerald-600">{{ $type->name }}</h3>
                                    </div>
                                    @if($type->description)
                    ...
                    @else
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <button wire:click="$set('selectedType', null)" class="text-sm text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                                    </svg>
                                    Change Type
                            ...
                            <div class="flex justify-end pt-4">
                                <button wire:click="saveEntry" wire:loading.attr="disabled" class="px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium rounded-xl shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2">
                                    <svg wire:loading wire:target="saveEntry" class="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                                ...
                                <li>
                                    <div class="relative pb-8">
                                        ...
                                        <div class="relative flex items-start space-x-3">
                                            <div class="relative">
                                                <div class="h-10 w-10 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center ring-8 ring-white dark:ring-gray-800">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <div>
                                                    <div class="text-sm">
                                                        ...
                                                        <span class="text-xs text-gray-500 dark:text-gray-400 ml-2">{{ $entry->treatmentType->name }}</span>
                                                    </div>
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div class="grid grid-cols-2 gap-2 mb-2">
                                                        @foreach($entry->formatted_answers as $key => $value)
                                                            <div class="text-sm">
                                                                <span class="font-medium text-gray-600 dark:text-gray-400">{{ ucfirst($key) }}:</span>
                                                    ...
                                                    @if($entry->notes)
                                                        <div class="text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3 border border-gray-100 dark:border-gray-700 mt-2">
                                                            {{ $entry->notes }}
                                                        </div>
                                                    @endif
                                                </div>
