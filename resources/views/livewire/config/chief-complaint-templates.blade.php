    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Chief Complaint
                        Templates</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Manage patient complaint options used during
                        consultations</p>
                </div>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                {{ $isEditing ? 'Update the template details' : 'Add a new complaint option for doctors'
                                }}
                            </p>
                        </div>
                    ...
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'create' }}" class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Complaint Name <span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
                                <input type="text" wire:model="name"
                                    ...
                                    placeholder="e.g., Fever, Headache, Abdominal Pain, Shortness of Breath" autofocus>
                                @error('name')
                            ...
                            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                Enter a clear, descriptive name for the complaint
                            </p>
                        </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150 group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <button wire:click="toggleStatus({{ $template->id }})"
                                    ...
                                    <span
                                        class="w-2 h-2 rounded-full mr-1.5 {{ $template->is_active ? 'bg-green-500' : 'bg-red-500' }}"></span>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button
                                        onclick="if(confirm('Are you sure you want to delete this template?')) { @this.delete({{ $template->id }}) }"
