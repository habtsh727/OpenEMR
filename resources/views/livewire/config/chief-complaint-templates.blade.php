<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        {{-- Header --}}
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Chief Complaint Templates</h1>
            <p class="text-gray-600 dark:text-gray-400">Manage chief complaint options for patients</p>
        </div>
            ...
            <form wire:submit.prevent="{{ $isEditing ? 'update' : 'create' }}">
                <div class="mb-4">
                    ...
                    <input type="text" wire:model="name"
                        ...
                        placeholder="e.g., Fever, Cough, Headache, Chest Pain">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                No chief complaint templates found. Create your first template above.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
