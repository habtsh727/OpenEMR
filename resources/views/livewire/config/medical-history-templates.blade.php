    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Medical History Templates</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Manage medical history options used during patient consultations</p>
                </div>
                
                {{-- Quick Stats --}}
                <div class="flex items-center space-x-4">
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl px-4 py-3">
                        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $templates->total() }}</div>
                    ...
                    @php
                        ...
                        $yesNoCount = $templates->where('field_type', 'yes_no')->count();
                    @endphp
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" 
                               ...
                               class="pl-10 pr-4 py-2.5 w-64 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200">
                    </div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                            <button wire:click="$set('fieldTypeFilter', null)" 
                                    class="px-3 py-1.5 text-sm rounded-md transition-all duration-200 {{ !$fieldTypeFilter ? 'bg-white dark:bg-gray-600 shadow-sm' : 'text-gray-600 dark:text-gray-400' }}">
                                All
                            </button>
                            <button wire:click="$set('fieldTypeFilter', 'yes_no')" 
                                    class="px-3 py-1.5 text-sm rounded-md transition-all duration-200 {{ $fieldTypeFilter === 'yes_no' ? 'bg-white dark:bg-gray-600 shadow-sm' : 'text-gray-600 dark:text-gray-400' }}">
                                Yes/No
                            </button>
                            <button wire:click="$set('fieldTypeFilter', 'text')" 
                                    class="px-3 py-1.5 text-sm rounded-md transition-all duration-200 {{ $fieldTypeFilter === 'text' ? 'bg-white dark:bg-gray-600 shadow-sm' : 'text-gray-600 dark:text-gray-400' }}">
                                Text
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                            <button wire:click="$set('filterActive', null)" 
                                    class="px-3 py-1.5 text-sm rounded-md transition-all duration-200 {{ !$filterActive ? 'bg-white dark:bg-gray-600 shadow-sm' : 'text-gray-600 dark:text-gray-400' }}">
                                All
                            </button>
                            <button wire:click="$set('filterActive', true)" 
                                    class="px-3 py-1.5 text-sm rounded-md transition-all duration-200 {{ $filterActive === true ? 'bg-white dark:bg-gray-600 shadow-sm' : 'text-gray-600 dark:text-gray-400' }}">
                                Active
                            </button>
                            <button wire:click="$set('filterActive', false)" 
                                    class="px-3 py-1.5 text-sm rounded-md transition-all duration-200 {{ $filterActive === false ? 'bg-white dark:bg-gray-600 shadow-sm' : 'text-gray-600 dark:text-gray-400' }}">
                                Inactive
                            </button>
                        </div>
                    </div>
                ...
                <button wire:click="$toggle('showForm')" 
                        class="flex items-center space-x-2 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    {{ $isEditing ? 'Update the medical history template' : 'Add a new medical history option for doctors' }}
                                </p>
                            </div>
                        ...
                        <form wire:submit.prevent="{{ $isEditing ? 'update' : 'create' }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                    Enter the medical condition or history item name
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    <label class="relative flex cursor-pointer">
                                        ...
                                        <div class="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 peer-checked:ring-2 peer-checked:ring-blue-200 dark:peer-checked:ring-blue-800 transition-all duration-200">
                                            <div class="flex items-center">
                                                <div class="w-5 h-5 rounded-full border border-gray-300 dark:border-gray-600 peer-checked:border-blue-500 peer-checked:bg-blue-500 flex items-center justify-center mr-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">Boolean choice</div>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                                        ...
                                        <div class="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20 peer-checked:ring-2 peer-checked:ring-green-200 dark:peer-checked:ring-green-800 transition-all duration-200">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">Text input</div>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                                        ...
                                        <div class="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-yellow-500 peer-checked:bg-yellow-50 dark:peer-checked:bg-yellow-900/20 peer-checked:ring-2 peer-checked:ring-yellow-200 dark:peer-checked:ring-yellow-800 transition-all duration-200">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">Numeric value</div>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                                    ...
                                    <label class="relative flex cursor-pointer">
                                        <input type="radio" wire:model="field_type" value="date" class="sr-only peer">
                                        <div class="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-purple-500 peer-checked:bg-purple-50 dark:peer-checked:bg-purple-900/20 peer-checked:ring-2 peer-checked:ring-purple-200 dark:peer-checked:ring-purple-800 transition-all duration-200">
                                            <div class="flex items-center">
                                                <div class="w-5 h-5 rounded-full border border-gray-300 dark:border-gray-600 peer-checked:border-purple-500 peer-checked:bg-purple-500 flex items-center justify-center mr-3">
                                                    <svg class="w-3 h-3 text-white hidden peer-checked:block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path>
                                                    </svg>
                                                </div>
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">Date picker</div>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        Active templates are visible to doctors during consultation
                                    </p>
                                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Template List</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    {{ $templates->total() }} template(s) found
                </p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150 group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-lg 
                                            {{ $template->field_type === 'yes_no' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 
                                               ($template->field_type === 'text' ? 'bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400' : 
                                               ($template->field_type === 'number' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400' : 
                                               'bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400')) }}">
                                            @if($template->field_type === 'yes_no')
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                </svg>
                                            @elseif($template->field_type === 'text')
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium 
                                        {{ $template->field_type === 'yes_no' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300' : 
                                           ($template->field_type === 'text' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 
                                           ($template->field_type === 'number' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300' : 
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button wire:click="toggleStatus({{ $template->id }})" 
                                        ...
                                        <span class="w-2 h-2 rounded-full mr-1.5 {{ $template->is_active ? 'bg-green-500' : 'bg-red-500' }}"></span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <button onclick="if(confirm('Are you sure you want to delete this template?')) { @this.delete({{ $template->id }}) }" 
                                ...
                                <td colspan="5" class="px-6 py-12">
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-500 dark:text-gray-400 mb-4">
                                            {{ $search || $filterActive !== null || $fieldTypeFilter ? 'Try adjusting your search or filter' : 'Get started by creating your first medical history template' }}
                                        </p>
                                        @if($search || $filterActive !== null || $fieldTypeFilter)
                                            <button wire:click="$set(['search' => '', 'filterActive' => null, 'fieldTypeFilter' => null])" 
