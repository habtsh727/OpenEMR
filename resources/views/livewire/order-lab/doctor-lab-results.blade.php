    ...
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-colors duration-200">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">View all lab tests grouped by patient encounter</p>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8 bg-indigo-100 dark:bg-indigo-900 rounded-lg flex items-center justify-center mr-2">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                {{ $labOrder->labTest->code }} • {{ $labOrder->labResults->count() }} parameters
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-1">
                                    <div class="text-sm text-gray-900 dark:text-white">
                                        <span class="font-medium">Encounter:</span> {{ $encounter->created_at->format('M d, Y') }}
                                    </div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                    ...
                                    <div class="text-sm text-gray-900 dark:text-white mt-2">
                                        <span class="font-medium">Latest Result:</span> {{ $latestResult->created_at->format('M d, Y') }}
                                    </div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <div class="space-y-2">
                                    <div>
                                        ...
                                        <div class="h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-green-500" style="width: {{ $totalTests > 0 ? ($reportedCount/$totalTests)*100 : 0 }}%"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-blue-500" style="width: {{ $totalTests > 0 ? ($verifiedCount/$totalTests)*100 : 0 }}%"></div>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button wire:click="viewEncounterResults({{ $encounter->id }})"
                                        x-data
