<div>
    <div class="max-h-[85vh] overflow-y-auto">
        <!-- Header -->
        <div
            class="sticky top-0 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 z-20 pb-4 border-b border-gray-200 dark:border-gray-700 px-6 pt-4">
        ...
        <div class="px-6 pt-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <!-- Total Tests -->
                <div
                    class="bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-800 p-4 rounded-xl border border-blue-100 dark:border-blue-800/50 shadow-sm">
                    <div class="flex items-center">
                        <div
                            class="flex-shrink-0 h-12 w-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center">
                            <svg class="h-6 w-6 text-blue-600 dark:text-blue-300" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Reported -->
                <div
                    class="bg-gradient-to-br from-green-50 to-white dark:from-green-900/20 dark:to-gray-800 p-4 rounded-xl border border-green-100 dark:border-green-800/50 shadow-sm">
                    <div class="flex items-center">
                        <div
                            class="flex-shrink-0 h-12 w-12 bg-green-100 dark:bg-green-900 rounded-lg flex items-center justify-center">
                ...
                <!-- Verified -->
                <div
                    class="bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-800 p-4 rounded-xl border border-purple-100 dark:border-purple-800/50 shadow-sm">
                    <div class="flex items-center">
                        <div
                            class="flex-shrink-0 h-12 w-12 bg-purple-100 dark:bg-purple-900 rounded-lg flex items-center justify-center">
                ...
                <!-- Action Required -->
                <div
                    class="bg-gradient-to-br from-amber-50 to-white dark:from-amber-900/20 dark:to-gray-800 p-4 rounded-xl border border-amber-100 dark:border-amber-800/50 shadow-sm">
                    <div class="flex items-center">
                        <div
                            class="flex-shrink-0 h-12 w-12 bg-amber-100 dark:bg-amber-900 rounded-lg flex items-center justify-center">
                            <svg class="h-6 w-6 text-amber-600 dark:text-amber-300" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mx-6 mb-6">
            <div
                class="bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div
                            class="h-10 w-10 bg-amber-100 dark:bg-amber-900 rounded-full flex items-center justify-center">
        ...
        <div class="px-6 pb-6 space-y-6">
            ...
            <div
                ...
                <!-- Test Header -->
                <div
                    class="px-6 py-4 bg-gradient-to-r from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-3">
                                <div
                                    class="h-12 w-12 bg-indigo-100 dark:bg-indigo-900 rounded-lg flex items-center justify-center">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            $statusConfig = [
                            'reported' => [
                            'color' => 'bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30
                            ...
                            'verified' => [
                            'color' => 'bg-gradient-to-r from-purple-100 to-violet-100 dark:from-purple-900/30
                            dark:to-violet-900/30',
                            ...
                            @endphp
                            <span
                                class="px-4 py-2 rounded-lg font-semibold text-sm flex items-center gap-2 {{ $config['color'] }} {{ $config['text'] }} {{ $config['border'] }}">
                                @if($config['icon'])
                            ...
                            <button wire:click="verifyTest({{ $labOrder->id }})" wire:loading.attr="disabled"
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($result->flag)
                                    <span
                                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold {{ $flag['bg'] }} {{ $flag['border'] }} {{ $flag['color'] }}">
                                        @if($flag['icon'])
                                    ...
                                    @else
                                    <span
                                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                                        Not Set
                                    </span>
                                    @endif
                                </td>
                ...
                <div class="px-6 py-12 text-center">
                    <svg class="h-12 w-12 text-gray-300 dark:text-gray-600 mx-auto" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @if($labOrders->where('status', 'reported')->count() > 0)
        <div
            class="sticky bottom-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-6 shadow-lg">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            {{ $labOrders->where('status', 'reported')->count() }} of {{ $labOrders->count() }} tests
                            are pending verification
                        </p>
                    </div>
                </div>
                <div class="flex flex-col sm:flex-row gap-3">
                    <button wire:click="verifyAll" wire:loading.attr="disabled"
                        wire:loading.class="opacity-50 cursor-not-allowed"
