<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div
                class="bg-gradient-to-br from-purple-600 via-purple-500 to-indigo-600 dark:from-purple-800 dark:via-purple-700 dark:to-indigo-800 rounded-2xl shadow-2xl overflow-hidden relative">
                {{-- Decorative Elements --}}
                <div
        ...
        <div class="space-y-6">
            ...
            <div
                ...
                <div
                    class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/50">
                    <div class="flex items-center space-x-3">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            @error('name') <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('base_price') <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}
                            </p> @enderror
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            @error('discount_value') <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message
                                }}</p> @enderror
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <div
                                class="w-full px-4 py-3 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 rounded-xl border-2 border-purple-200 dark:border-purple-800">
                                <span class="text-2xl font-bold text-purple-600 dark:text-purple-400">ETB{{
            ...
            @if($showItemForm)
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border-2 border-purple-200 dark:border-purple-800 overflow-hidden transform transition-all duration-300">
                <div
                    class="px-6 py-4 bg-gradient-to-r from-purple-50 via-purple-100 to-indigo-50 dark:from-purple-900/30 dark:via-purple-900/20 dark:to-indigo-900/30 border-b border-purple-200 dark:border-purple-800">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <button type="button" wire:click="$set('selectedItemType', 'standard_medication')"
                                ...
                                <svg class="w-10 h-10 mx-auto mb-2 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                                    </path>
                                </svg>
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Standard
                                    Medication</span>
                            </button>
                            ...
                            <button type="button" wire:click="$set('selectedItemType', 'custom_medication')"
                                ...
                                <svg class="w-10 h-10 mx-auto mb-2 text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                    </path>
                                </svg>
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Custom
                                    Medication</span>
                            </button>
                            ...
                            <button type="button" wire:click="$set('selectedItemType', 'service')"
                                ...
                                <svg class="w-10 h-10 mx-auto mb-2 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <button type="button" wire:click="$set('selectedItemType', 'bed')"
                                ...
                                <svg class="w-10 h-10 mx-auto mb-2 text-yellow-600 dark:text-yellow-400 group-hover:scale-110 transition-transform"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                @error('currentItem.item_name') <p class="mt-1 text-sm text-red-600 dark:text-red-400">
                                    {{ $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('currentItem.dosage') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{
                                    $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('currentItem.frequency') <p class="mt-1 text-sm text-red-600 dark:text-red-400">
                                    {{ $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('currentItem.duration') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{
                                    $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('currentItem.quantity') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{
                                    $message }}</p> @enderror
                            </div>
                            @endif
                            ...
                            <div class="md:col-span-2">
                                ...
                                @error('currentItem.bed_duration_days') <p
            ...
            <div
                ...
                <div
                    class="px-6 py-4 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-900/20 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <h2 class="text-lg font-semibold text-purple-900 dark:text-purple-300">Standard Medications
                            </h2>
                        </div>
                        <span
                            class="px-3 py-1 bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-300 rounded-full text-sm font-medium">{{
                            count($standardMedications) }} items</span>
                    </div>
                </div>
                <div class="p-6 space-y-4">
                    @foreach($standardMedications as $index => $med)
                    <div
                        class="group border border-gray-200 dark:border-gray-700 rounded-xl p-5 hover:shadow-xl hover:border-purple-200 dark:hover:border-purple-700 transition-all duration-200">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                <div class="flex items-center space-x-3 mb-3">
                                    <span
                                        class="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 text-xs font-medium rounded-full">Standard</span>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                    <div class="bg-gray-50 dark:bg-gray-700/50 p-2 rounded-lg">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-white">{{ $med['dosage']
                                            }}</span>
                                    </div>
                                    <div class="bg-gray-50 dark:bg-gray-700/50 p-2 rounded-lg">
                                        <span class="text-gray-500 dark:text-gray-400 block text-xs">Frequency</span>
                                        <span class="font-medium text-gray-900 dark:text-white">{{ $med['frequency']
                                            }}</span>
                                    </div>
                                    <div class="bg-gray-50 dark:bg-gray-700/50 p-2 rounded-lg">
                                        <span class="text-gray-500 dark:text-gray-400 block text-xs">Duration</span>
                                        <span class="font-medium text-gray-900 dark:text-white">{{ $med['duration']
                                            }}</span>
                                    </div>
                                    <div class="bg-gray-50 dark:bg-gray-700/50 p-2 rounded-lg">
                                        <span class="text-gray-500 dark:text-gray-400 block text-xs">Quantity</span>
                                        <span class="font-medium text-gray-900 dark:text-white">{{ $med['quantity']
                                            }}</span>
                                    </div>
                                </div>
            ...
            @if(count($customMedications) > 0)
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div
                    class="px-6 py-4 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-900/20 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <div class="p-2 bg-green-200 dark:bg-green-800 rounded-lg">
                                <svg class="w-5 h-5 text-green-700 dark:text-green-300" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                    </path>
                            ...
                            <h2 class="text-lg font-semibold text-green-900 dark:text-green-300">Custom Medications</h2>
                        </div>
                        <span
                            class="px-3 py-1 bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-300 rounded-full text-sm font-medium">{{
                            count($customMedications) }} items</span>
                    </div>
                </div>
                <div class="p-6 space-y-4">
                    @foreach($customMedications as $index => $med)
                    <div
                        class="group border border-gray-200 dark:border-gray-700 rounded-xl p-5 hover:shadow-xl hover:border-green-200 dark:hover:border-green-700 transition-all duration-200">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                <div class="flex items-center space-x-3 mb-3">
                                    <span
                                        class="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 text-xs font-medium rounded-full">Custom</span>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">{{ $med['item_name'] }}</h4>
                                </div>
                            ...
                            <div class="flex space-x-2 ml-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button type="button" wire:click="editItem('custom_medication', {{ $index }})"
                                    class="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z">
                                ...
                                <button type="button" wire:click="removeItem('custom_medication', {{ $index }})"
                                    onclick="return confirm('Remove this medication?')"
                                    class="p-2 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-200 dark:hover:bg-red-800 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div
                    class="px-6 py-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-900/20 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <h2 class="text-lg font-semibold text-blue-900 dark:text-blue-300">Services</h2>
                        </div>
                        <span
                            class="px-3 py-1 bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-300 rounded-full text-sm font-medium">{{
                            count($services) }} items</span>
                    </div>
                </div>
                <div class="p-6 space-y-4">
                    @foreach($services as $index => $service)
                    <div
                        class="group border border-gray-200 dark:border-gray-700 rounded-xl p-5 hover:shadow-xl hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-200">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                <div class="flex items-center space-x-3 mb-3">
                                    <span
                                        class="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 text-xs font-medium rounded-full">Service</span>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">{{ $service['item_name'] }}
                                    </h4>
                                </div>
                            ...
                            <div class="flex space-x-2 ml-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button type="button" wire:click="editItem('service', {{ $index }})"
                                    class="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z">
                                ...
                                <button type="button" wire:click="removeItem('service', {{ $index }})"
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div
                    class="px-6 py-4 bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/30 dark:to-yellow-900/20 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <h2 class="text-lg font-semibold text-yellow-900 dark:text-yellow-300">Bed Accommodation
                            </h2>
                        </div>
                        <span
                            class="px-3 py-1 bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-300 rounded-full text-sm font-medium">1
                            item</span>
                    </div>
                </div>
                <div class="p-6">
                    <div
                        class="group border border-gray-200 dark:border-gray-700 rounded-xl p-5 hover:shadow-xl hover:border-yellow-200 dark:hover:border-yellow-700 transition-all duration-200">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                <div class="flex items-center space-x-3 mb-3">
                                    <span
                                        class="px-3 py-1 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 text-xs font-medium rounded-full">Bed</span>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">Bed Accommodation</h4>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    <div class="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-white">{{
                                            $bed['bed_duration_days'] }} days</span>
                                    </div>
                                </div>
                                ...
                                @if($bed['notes'])
                                <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    <span class="font-medium">Notes:</span> {{ $bed['notes'] }}
                                </div>
                                @endif
                            </div>

                            <div class="flex space-x-2 ml-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button type="button" wire:click="editBed"
                                    class="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z">
            ...
            <div
                ...
                <div class="p-6">
                    <label class="flex items-center space-x-3 cursor-pointer">
                        ...
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Active (available for
                            use)</span>
                    </label>
                </div>
            </div>
            ...
            <div class="sticky bottom-6 z-10">
                <div
                    class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 p-6 backdrop-blur-xl bg-white/80 dark:bg-gray-800/80">
