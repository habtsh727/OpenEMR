            ...
            <div class="mt-8">
                <div class="flex items-center">
                    ...
                    <button wire:click="goToStep(1)" 
                        ...
                        <div class="ml-3">
                            <div class="text-sm font-medium {{ $currentStep == 1 ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400' }}">
                                Vital Signs
                            </div>
                    ...
                    <!-- Connector -->
                    <div class="flex-1 h-0.5 mx-4 {{ $currentStep > 1 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700' }}"></div>
                    ...
                    <button wire:click="goToStep(2)" 
                        ...
                        <div class="ml-3">
                            <div class="text-sm font-medium {{ $currentStep == 2 ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400' }}">
                                Medical History
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <div class="font-medium">
                                <span class="px-2 py-1 rounded-full text-xs {{ $this->getPriorityClass($encounter->priority) }}">
                        ...
                        @foreach($medicalHistories as $history)
                            <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-0">
                                ...
                                @switch($history['field_type'])
                                    @case('yes_no')
                                        <div class="flex space-x-6">
                                            <label class="inline-flex items-center">
                                                <input type="radio" 
                                                       wire:model="medicalHistories.{{ $history['template_id'] }}.value"
                                                       value="yes"
                                    ...
                                    @case('text')
                                        <textarea wire:model.lazy="medicalHistories.{{ $history['template_id'] }}.value"
                                                  rows="2"
                                    ...
                                    @case('number')
                                        <input type="number" 
                                               wire:model.lazy="medicalHistories.{{ $history['template_id'] }}.value"
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-between">
                        ...
                        <div class="flex space-x-3">
                            <button type="submit"
                                ...
                                <svg wire:loading wire:target="saveMedicalHistory" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
                            ...
                            <button type="button"
                                    wire:click="completeAndContinue"
                                    wire:loading.attr="disabled"
                                    class="inline-flex items-center px-5 py-2.5 border border-transparent rounded-lg text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800">
                                Save & Continue
                                <svg class="ml-2 -mr-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
