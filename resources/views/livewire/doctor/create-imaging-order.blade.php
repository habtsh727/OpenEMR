        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-6">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-100 dark:border-yellow-800 rounded-xl px-4 py-3">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-center">
                    <div class="flex items-center">
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-500 flex items-center justify-center mb-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
                        ...
                        <div class="px-6 py-4 bg-blue-50 dark:bg-blue-900/10 border-b border-blue-100 dark:border-blue-800">
                            <div class="flex items-start space-x-3">
                                <svg class="w-5 h-5 text-blue-500 dark:text-blue-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 01118 0z"></path>
                                </svg>
                    ...
                    <div class="p-6">
                        <form wire:submit.prevent="createOrder" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <label class="relative flex cursor-pointer">
                                            <input type="radio" wire:model="priority" value="routine" class="sr-only peer" checked>
                                            <div class="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 peer-checked:ring-2 peer-checked:ring-blue-200 dark:peer-checked:ring-blue-800 transition-all duration-200">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        <div class="font-medium text-gray-900 dark:text-white">Routine</div>
                                                        <div class="text-xs text-gray-500 dark:text-gray-400">Next 24-48 hours</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                                            ...
                                            <div class="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-red-500 peer-checked:bg-red-50 dark:peer-checked:bg-red-900/20 peer-checked:ring-2 peer-checked:ring-red-200 dark:peer-checked:ring-red-800 transition-all duration-200">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-xs text-gray-500 dark:text-gray-400">Immediate attention</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="pl-8 w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700/50 dark:text-white">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Clinical Notes <small class="text-gray-500 dark:text-gray-400">(For Radiologist)</small>
                                </label>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @php
                                                    $statusConfig = [
                                                        ...
                                                        'paid' => ['color' => 'blue', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                                                        'in_progress' => ['color' => 'purple', 'icon' => 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15'],
                                                ...
                                                @endphp
                                                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-{{ $config['color'] }}-100 text-{{ $config['color'] }}-800 dark:bg-{{ $config['color'] }}-900/30 dark:text-{{ $config['color'] }}-300">
