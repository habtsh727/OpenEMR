<div>
    ...
    <div class="px-6 py-4 border-b">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-3">
                ...
                <button wire:click="$set('showSubmitConfirm', true)" 
    ...
    <div class="px-6 py-4 border-b bg-gray-50">
        ...
        <div class="mt-2 absolute z-50 w-full bg-white border border-gray-200 rounded-lg shadow-lg max-h-96 overflow-y-auto">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item->frequency->name ?? '-' }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        ...
                        <button wire:click="removeItem({{ $item->id }})" 
                                wire:confirm="Remove this medication?"
                ...
                <tr>
                    <td colspan="9" class="px-6 py-8 text-center text-gray-500">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No medications added</h3>
                        <p class="mt-1 text-sm text-gray-500">Search and add medications to create an order.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <form wire:submit="addItem" class="mt-4 space-y-4">
                            ...
                            <div>
                                ...
                                @error('itemType') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 grid grid-cols-2 gap-3">
                                    <select wire:model="itemDiscountType" 
                                    ...
                                    <input type="number" wire:model="itemDiscountValue" 
                                           {{ !$itemDiscountType ? 'disabled' : '' }}
                                           class="border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                           placeholder="{{ $itemDiscountType === 'percentage' ? '%' : '₦' }}"
                                           min="0"
                                           {{ $itemDiscountType === 'percentage' ? 'max="100"' : '' }}>
                                    @error('itemDiscountValue') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                </div>
                            </div>
...
<div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" 
                        wire:click="$set('showCustomMedicationModal', false)"
                        class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                    Close
                </button>
            </div>
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Are you sure you want to submit this medication order? Once submitted, it will be sent to the pharmacy for processing.
                            </p>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <button type="button" 
                        wire:click="$set('showSubmitConfirm', false)"
                        class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                    Cancel
                </button>
            </div>
