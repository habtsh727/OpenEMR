    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900">
        ...
        <div class="px-6 py-4 border-b dark:border-gray-700">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Medication Order</h2>
        ...
        <!-- Search Bar -->
        <div class="px-6 py-4 border-b bg-gray-50 dark:bg-gray-900 dark:border-gray-700">
            <div class="relative">
                <input type="text" wire:model.live.debounce.300ms="searchQuery"
                    class="w-full px-4 py-3 pl-10 pr-12 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 focus:border-blue-500 dark:focus:border-blue-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <div
                class="mt-2 absolute z-50 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg dark:shadow-gray-900 max-h-96 overflow-y-auto">
                <!-- Standard Medications -->
                @if(count($searchResults) > 0)
                <div class="p-2 border-b dark:border-gray-700">
                    <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Standard Medications</h3>
                    @foreach($searchResults as $medication)
                    <button wire:click="selectMedication({{ json_encode($medication) }})"
                        class="w-full text-left p-3 hover:bg-blue-50 dark:hover:bg-blue-900/30 cursor-pointer border-b dark:border-gray-700 last:border-b-0 transition-colors">
                ...
                <div class="p-2">
                    <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Custom Medications</h3>
                    @foreach($customSearchResults as $medication)
                    <button wire:click="selectMedication({{ json_encode($medication) }})"
                        class="w-full text-left p-3 hover:bg-purple-50 dark:hover:bg-purple-900/30 cursor-pointer border-b dark:border-gray-700 last:border-b-0 transition-colors">
                        <div class="flex justify-between items-start">
                            <div>
                                <h4 class="font-medium text-gray-900 dark:text-gray-100">{{ $medication['name'] }}</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <div class="flex items-center">
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                        ...
                                        <span
                                            class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
                                            Custom
                                        </span>
                                        @endif
                                    </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button wire:click="editItem({{ $item->id }})"
                                class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 mr-3 transition-colors">Edit</button>
                            <button wire:click="removeItem({{ $item->id }})" wire:confirm="Remove this medication?"
                                class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300 transition-colors">Remove</button>
                        </td>
                    </tr>
                    @empty
                    <tr>
        ...
        <!-- Order Summary -->
        <div class="px-6 py-4 border-t bg-gray-50 dark:bg-gray-900 dark:border-gray-700">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Order Discount -->
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg border dark:border-gray-700">
                    <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Order Discount</h3>
                    <div class="space-y-3">
                        <div class="flex space-x-3">
                            <select wire:model.live="discountType" wire:change="calculateTotals"
                                class="w-1/2 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 focus:border-blue-500 dark:focus:border-blue-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                ...
                <!-- Totals -->
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg border dark:border-gray-700">
                    <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Order Summary</h3>
                    <div class="space-y-2">
                ...
                <!-- Order Info -->
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg border dark:border-gray-700">
                    <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Order Information</h3>
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            {{ $order->status === 'draft' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' : 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200' }}">
