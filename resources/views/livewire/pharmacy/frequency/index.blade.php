<div>
    <x-shared-form :editing-id="$editingId">
        <div>
            ...
            <input wire:model="name" placeholder="Frequency"
        ...
        <div>
            ...
            <input wire:model="short_code" placeholder="Short code"
                class="w-full px-3.5 py-2.5 text-sm border border-sky-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all duration-200 placeholder-gray-400" />
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5">Times/day</label>
            <input wire:model="times" type="number" placeholder="Times/day"
                class="w-full px-3.5 py-2.5 text-sm border border-sky-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all duration-200 placeholder-gray-400" />
        </div>
    </x-shared-form>
