<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
    ...
    <!-- Alert Notification (same as Type Manager) -->
                ...
                <div class="relative p-6 md:p-8">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 class="text-2xl md:text-3xl font-bold text-white">Cupping Locations</h1>
                                <p class="text-gray-300 mt-1">Manage cupping therapy body locations</p>
                            </div>
                        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Cupping Locations List</h2>
                    <span class="px-2 py-0.5 bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-full text-xs">{{ $locations->total() }} locations</span>
                </div>
            </div>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50 dark:bg-gray-700/50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Location Name</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($locations as $index => $location)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <p class="text-sm text-gray-600 dark:text-gray-400 max-w-md line-clamp-2">{{ $location->description ?? 'No description' }}</p>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <button wire:click="toggleStatus({{ $location->id }})" 
                                        class="px-3 py-1 rounded-full text-xs font-medium transition-colors
                                        {{ $location->status ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 hover:bg-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400 hover:bg-red-200' }}">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No cupping locations found</h3>
                                        <p class="text-gray-500 dark:text-gray-400">
                                            {{ $search ? 'No results match your search. Try a different term.' : 'Create your first cupping location to get started.' }}
                                        </p>
                                        @if($search)
                ...
                <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                    <div class="flex items-center justify-between flex-wrap gap-4">
                        <div class="text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <span class="font-medium">{{ $locations->total() }}</span> results
                        </div>
                        <div>
                            {{ $locations->links() }}
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-900 dark:to-gray-950 px-6 py-4 flex justify-between items-center">
                        <div>
                            <h2 class="text-xl font-bold text-white">
                                {{ $isEditing ? 'Edit Cupping Location' : 'Create Cupping Location' }}
                            </h2>
                            <p class="text-gray-300 text-sm mt-1">
                                {{ $isEditing ? 'Update the cupping location details' : 'Add a new body location for cupping therapy' }}
                            </p>
                        </div>
                        ...
                        <form wire:submit.prevent="save" class="space-y-6">
                            <div>
                                ...
                                <input type="text" wire:model="name" 
                                    ...
                                    placeholder="e.g., Head, Back, Legs, Shoulders">
                            ...
                            <div>
                                ...
                                <textarea wire:model="description" rows="4" 
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-700 dark:text-white transition-colors duration-200"
                                    placeholder="Describe this cupping location..."></textarea>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-8">Inactive locations won't appear in the doctor's order form</p>
                            </div>
            ...
            <div class="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6 animate-fade-in-up">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Delete Cupping Location</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">This action cannot be undone.</p>
                        </div>
                    </div>
                    
                    <p class="text-gray-600 dark:text-gray-300 mb-6">
                        Are you sure you want to delete this cupping location? This will permanently remove it from the system.
                    </p>
