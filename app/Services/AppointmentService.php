...
class AppointmentService
{
    ...
    {
        Log::info('generateTimeSlots called', [
            'doctor_id' => $doctorId, 
            'date' => $date
        ]);
        
        try {
            $startTime = Carbon::parse($date . ' 08:00', 'Africa/Addis_Ababa');
            $endTime = Carbon::parse($date . ' 17:00', 'Africa/Addis_Ababa');
            $slots = [];
            ...
            Log::info('Booked slots', ['booked' => $bookedSlots]);
            ...
            Log::error('Error generating slots', [
                'error' => $e->getMessage(),
                'doctor_id' => $doctorId,
                'date' => $date
            ]);
